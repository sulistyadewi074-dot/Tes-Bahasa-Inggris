 ...
 * SD NEGERI 3 LOLOAN TIMUR - KELAS V
 * Mata Pelajaran: BAHASA INGGRIS (Materi: Healthy Vegetables)
 */
...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_questions_vegetables_v1';
...
export default function App() {
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan distribusi 30 butir soal materi Healthy Vegetables (15 PG, 5 PGK, 5 PGK Kategori, 5 Isian Singkat)
  ...
  // Reset soal ke 30 butir standar materi Healthy Vegetables (15 PG, 5 PGK, 5 PGK Kategori, 5 Isian)
