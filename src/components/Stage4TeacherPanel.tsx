            ...
            {questions.map((q) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className="font-extrabold text-xs px-2.5 py-1 rounded bg-emerald-700 text-white">
                      #{q.id}
                    </span>
                  ...
                  <div className="space-y-1.5 text-xs">
                    {q.statements.map((st, sIdx) => (
                      ...
                      >
                        ...
                        >
                          {st.correctAnswer ? (st.trueLabel || 'BENAR') : (st.falseLabel || 'SALAH')}
                        </span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="p-2.5 bg-white rounded-lg border border-slate-200 text-xs">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {q.acceptedAnswers && q.acceptedAnswers.length > 1 && (
                        <span className="text-slate-500">
                          (Variasi diterima: {q.acceptedAnswers.join(', ')})
                        </span>
                      )}
                    </div>
                  </div>
                ...
                {/* Pembahasan */}
                <div className="p-2.5 rounded-lg bg-emerald-50/60 border border-emerald-100 text-xs text-slate-700">
