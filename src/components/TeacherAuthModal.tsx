        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Masukkan kata sandi guru untuk mengelola rekap nilai &amp; bank soal
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <input
                ...
                autoFocus
                className="w-full px-3.5 py-2.5 text-sm rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 pr-10"
              />
              <button
                type="button"
            ...
            <p className="mt-1.5 text-[11px] text-slate-400">
              Akses khusus Guru Kelas V / Administrator SD Negeri 3 Loloan Timur.
            </p>
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <button
              id="btn-submit-auth"
              type="submit"
              className="px-5 py-2.5 text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl transition-colors shadow-xs cursor-pointer"
            >
              Masuk Dashboard
            </button>
          </div>
